...
## [題目敘述](https://leetcode.com/problems/number-of-students-unable-to-eat-lunch/?envType=daily-question&envId=2024-04-08)
...
class Solution {
    public int countStudents(int[] students, int[] sandwiches) {
        ...
        for (int sandwich : sandwiches) {
            while (studentsQueue.peek() != sandwich) {
                if (tmp == studentsQueue.size()) {
